...
/*
 * feature: shop owner can see sales / report
 * */
public class Menu {
    ...
    private void collectUserInfoAndAddUser() {
        ...
        // this is tenary operator; a simplified version of if statement that allows you to assign data to variable based on condition
